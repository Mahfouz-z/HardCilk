#ifndef __GENERATED_PAPER_EXP1__PECOUNT_16__VSSNUMBER_6_INCLUDED_
#define __GENERATED_PAPER_EXP1__PECOUNT_16__VSSNUMBER_6_INCLUDED_
...
#include "Vpaper_exp1__peCount_16__vssNumber_6.h"

namespace paper_exp1::generated
{

struct paper_exp1__peCount_16__vssNumber_6 :
    Vpaper_exp1__peCount_16__vssNumber_6,
    sctlm::tlm_lib::tlm_module
{
    SC_HAS_PROCESS(paper_exp1__peCount_16__vssNumber_6);

    explicit paper_exp1__peCount_16__vssNumber_6(sc_core::sc_module_name const &name);
    ...
    void verilated_trace(VerilatedVcdC* tfp, int levels, int options = 0) {
        Vpaper_exp1__peCount_16__vssNumber_6::trace(tfp, levels, options);
    }
#endif
...
#endif // __GENERATED_PAPER_EXP1__PECOUNT_16__VSSNUMBER_6_INCLUDED_
