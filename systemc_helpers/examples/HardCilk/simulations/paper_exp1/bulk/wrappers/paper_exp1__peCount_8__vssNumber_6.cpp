#include "paper_exp1__peCount_8__vssNumber_6.hpp"

namespace paper_exp1::generated
{

paper_exp1__peCount_8__vssNumber_6::paper_exp1__peCount_8__vssNumber_6(sc_core::sc_module_name const &name):
    Vpaper_exp1__peCount_8__vssNumber_6(name),
...
void paper_exp1__peCount_8__vssNumber_6::reset_n_generate_()
{
    reset_n_.write(!reset.read());
}

void paper_exp1__peCount_8__vssNumber_6::do_connect_()
{
    /* initialize bridges */
...
void paper_exp1__peCount_8__vssNumber_6::do_init_()
{
    set("clock", clock);
    set("reset", reset);
...
flexitask::desc::FlexiTaskSystem paper_exp1__peCount_8__vssNumber_6::description = [] {
