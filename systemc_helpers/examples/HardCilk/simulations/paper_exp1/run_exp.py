...
# check if matplotlib is installed otherwise install it
try:
...
SIMULATION_NAME = "paper_exp1"
GROUP_NAME = ["paper_exp1_effficiency", "paper_exp1_scalability"]
...
class Entry(EntryBase):
    ...
    def register(self) -> None:
        sim = Simulation(
            ...
            executable="simulation_paper_exp1",
            parameters={
                "delayCycles": int,
                "factoryIndex": int
            },
