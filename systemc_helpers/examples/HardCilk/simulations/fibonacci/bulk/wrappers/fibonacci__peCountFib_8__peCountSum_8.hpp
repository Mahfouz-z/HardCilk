#ifndef __GENERATED_FIBONACCI__PECOUNTFIB_8__PECOUNTSUM_8_INCLUDED_
#define __GENERATED_FIBONACCI__PECOUNTFIB_8__PECOUNTSUM_8_INCLUDED_
...
#include "Vfibonacci__peCountFib_8__peCountSum_8.h"

namespace fibonacci::generated
{

struct fibonacci__peCountFib_8__peCountSum_8 :
    Vfibonacci__peCountFib_8__peCountSum_8,
    sctlm::tlm_lib::tlm_module
{
    SC_HAS_PROCESS(fibonacci__peCountFib_8__peCountSum_8);

    explicit fibonacci__peCountFib_8__peCountSum_8(sc_core::sc_module_name const &name);
    ...
    void verilated_trace(VerilatedVcdC* tfp, int levels, int options = 0) {
        Vfibonacci__peCountFib_8__peCountSum_8::trace(tfp, levels, options);
    }
#endif
...
#endif // __GENERATED_FIBONACCI__PECOUNTFIB_8__PECOUNTSUM_8_INCLUDED_
