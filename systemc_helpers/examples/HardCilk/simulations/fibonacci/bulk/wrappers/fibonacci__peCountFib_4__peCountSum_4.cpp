#include "fibonacci__peCountFib_4__peCountSum_4.hpp"

namespace fibonacci::generated
{

fibonacci__peCountFib_4__peCountSum_4::fibonacci__peCountFib_4__peCountSum_4(sc_core::sc_module_name const &name):
    Vfibonacci__peCountFib_4__peCountSum_4(name),
...
void fibonacci__peCountFib_4__peCountSum_4::reset_n_generate_()
{
    reset_n_.write(!reset.read());
}

void fibonacci__peCountFib_4__peCountSum_4::do_connect_()
{
    /* initialize bridges */
...
void fibonacci__peCountFib_4__peCountSum_4::do_init_()
{
    set("clock", clock);
    set("reset", reset);
...
flexitask::desc::FlexiTaskSystem fibonacci__peCountFib_4__peCountSum_4::description = [] {
