#include "fibonacci__peCountFib_16__peCountSum_16.hpp"

namespace fibonacci::generated
{

fibonacci__peCountFib_16__peCountSum_16::fibonacci__peCountFib_16__peCountSum_16(sc_core::sc_module_name const &name):
    Vfibonacci__peCountFib_16__peCountSum_16(name),
...
void fibonacci__peCountFib_16__peCountSum_16::reset_n_generate_()
{
    reset_n_.write(!reset.read());
}

void fibonacci__peCountFib_16__peCountSum_16::do_connect_()
{
    /* initialize bridges */
...
void fibonacci__peCountFib_16__peCountSum_16::do_init_()
{
    set("clock", clock);
    set("reset", reset);
...
hardcilk::desc::HardCilkSystem fibonacci__peCountFib_16__peCountSum_16::description = [] {
