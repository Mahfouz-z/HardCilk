#ifndef __GENERATED_FIBONACCI__PECOUNTFIB_4__PECOUNTSUM_4_INCLUDED_
#define __GENERATED_FIBONACCI__PECOUNTFIB_4__PECOUNTSUM_4_INCLUDED_
...
#include "Vfibonacci__peCountFib_4__peCountSum_4.h"

namespace fibonacci::generated
{

struct fibonacci__peCountFib_4__peCountSum_4 :
    Vfibonacci__peCountFib_4__peCountSum_4,
    sctlm::tlm_lib::tlm_module
{
    SC_HAS_PROCESS(fibonacci__peCountFib_4__peCountSum_4);

    explicit fibonacci__peCountFib_4__peCountSum_4(sc_core::sc_module_name const &name);
    ...
    void verilated_trace(VerilatedVcdC* tfp, int levels, int options = 0) {
        Vfibonacci__peCountFib_4__peCountSum_4::trace(tfp, levels, options);
    }
#endif
...
#endif // __GENERATED_FIBONACCI__PECOUNTFIB_4__PECOUNTSUM_4_INCLUDED_
