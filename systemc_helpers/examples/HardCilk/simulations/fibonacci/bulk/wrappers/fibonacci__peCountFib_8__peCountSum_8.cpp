#include "fibonacci__peCountFib_8__peCountSum_8.hpp"

namespace fibonacci::generated
{

fibonacci__peCountFib_8__peCountSum_8::fibonacci__peCountFib_8__peCountSum_8(sc_core::sc_module_name const &name):
    Vfibonacci__peCountFib_8__peCountSum_8(name),
...
void fibonacci__peCountFib_8__peCountSum_8::reset_n_generate_()
{
    reset_n_.write(!reset.read());
}

void fibonacci__peCountFib_8__peCountSum_8::do_connect_()
{
    /* initialize bridges */
...
void fibonacci__peCountFib_8__peCountSum_8::do_init_()
{
    set("clock", clock);
    set("reset", reset);
...
flexitask::desc::FlexiTaskSystem fibonacci__peCountFib_8__peCountSum_8::description = [] {
