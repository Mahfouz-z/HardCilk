#include "paper_exp_dae_0__peCountExecute_4__vssNumberExecute_1.hpp"

namespace paper_exp_dae_0::generated
{

paper_exp_dae_0__peCountExecute_4__vssNumberExecute_1::paper_exp_dae_0__peCountExecute_4__vssNumberExecute_1(sc_core::sc_module_name const &name):
    Vpaper_exp_dae_0__peCountExecute_4__vssNumberExecute_1(name),
...
void paper_exp_dae_0__peCountExecute_4__vssNumberExecute_1::reset_n_generate_()
{
    reset_n_.write(!reset.read());
}

void paper_exp_dae_0__peCountExecute_4__vssNumberExecute_1::do_connect_()
{
    /* initialize bridges */
...
void paper_exp_dae_0__peCountExecute_4__vssNumberExecute_1::do_init_()
{
    set("clock", clock);
    set("reset", reset);
...
flexitask::desc::FlexiTaskSystem paper_exp_dae_0__peCountExecute_4__vssNumberExecute_1::description = [] {
