#ifndef __GENERATED_PAPER_EXP_DAE_0__PECOUNTEXECUTE_4__VSSNUMBEREXECUTE_1_INCLUDED_
#define __GENERATED_PAPER_EXP_DAE_0__PECOUNTEXECUTE_4__VSSNUMBEREXECUTE_1_INCLUDED_
...
#include "Vpaper_exp_dae_0__peCountExecute_4__vssNumberExecute_1.h"

namespace paper_exp_dae_0::generated
{

struct paper_exp_dae_0__peCountExecute_4__vssNumberExecute_1 :
    Vpaper_exp_dae_0__peCountExecute_4__vssNumberExecute_1,
    sctlm::tlm_lib::tlm_module
{
    SC_HAS_PROCESS(paper_exp_dae_0__peCountExecute_4__vssNumberExecute_1);

    explicit paper_exp_dae_0__peCountExecute_4__vssNumberExecute_1(sc_core::sc_module_name const &name);
    ...
    void verilated_trace(VerilatedVcdC* tfp, int levels, int options = 0) {
        Vpaper_exp_dae_0__peCountExecute_4__vssNumberExecute_1::trace(tfp, levels, options);
    }
#endif
...
#endif // __GENERATED_PAPER_EXP_DAE_0__PECOUNTEXECUTE_4__VSSNUMBEREXECUTE_1_INCLUDED_
