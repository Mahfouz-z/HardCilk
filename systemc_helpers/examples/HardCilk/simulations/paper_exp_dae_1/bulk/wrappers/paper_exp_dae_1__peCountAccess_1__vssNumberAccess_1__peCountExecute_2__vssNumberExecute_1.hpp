#ifndef __GENERATED_PAPER_EXP_DAE_1__PECOUNTACCESS_1__VSSNUMBERACCESS_1__PECOUNTEXECUTE_2__VSSNUMBEREXECUTE_1_INCLUDED_
#define __GENERATED_PAPER_EXP_DAE_1__PECOUNTACCESS_1__VSSNUMBERACCESS_1__PECOUNTEXECUTE_2__VSSNUMBEREXECUTE_1_INCLUDED_
...
#include "Vpaper_exp_dae_1__peCountAccess_1__vssNumberAccess_1__peCountExecute_2__vssNumberExecute_1.h"

namespace paper_exp_dae_1::generated
{

struct paper_exp_dae_1__peCountAccess_1__vssNumberAccess_1__peCountExecute_2__vssNumberExecute_1 :
    Vpaper_exp_dae_1__peCountAccess_1__vssNumberAccess_1__peCountExecute_2__vssNumberExecute_1,
    sctlm::tlm_lib::tlm_module
{
    SC_HAS_PROCESS(paper_exp_dae_1__peCountAccess_1__vssNumberAccess_1__peCountExecute_2__vssNumberExecute_1);

    explicit paper_exp_dae_1__peCountAccess_1__vssNumberAccess_1__peCountExecute_2__vssNumberExecute_1(sc_core::sc_module_name const &name);
    ...
    void verilated_trace(VerilatedVcdC* tfp, int levels, int options = 0) {
        Vpaper_exp_dae_1__peCountAccess_1__vssNumberAccess_1__peCountExecute_2__vssNumberExecute_1::trace(tfp, levels, options);
    }
#endif
...
#endif // __GENERATED_PAPER_EXP_DAE_1__PECOUNTACCESS_1__VSSNUMBERACCESS_1__PECOUNTEXECUTE_2__VSSNUMBEREXECUTE_1_INCLUDED_
