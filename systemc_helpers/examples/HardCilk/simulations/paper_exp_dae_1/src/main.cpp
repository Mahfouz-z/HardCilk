...
int sc_main(int argc, char* argv[]) {
    ...
    constexpr const char* name = "paper_exp_dae_1";
    ...
    argParser.arg<unsigned int>("pe_access.requestQueueSize", 16);
    argParser.arg<unsigned int>("pe_access.numParallelRequests", 32);
    argParser.arg<unsigned int>("pe_access.delay_ns", 70);
    ...
    auto& factory = paper_exp_dae_1::factories[context.get<unsigned int>("factoryIndex")];
    ...
    auto& remainingTasks = context.set<int>("remainingTasks", 2 * g->size() - 1);
