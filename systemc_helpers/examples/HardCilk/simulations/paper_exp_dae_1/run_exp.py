...
SIMULATION_NAME = "paper_exp_dae_1"
GROUP_NAME = "paper_exp_dae_1"


class Entry(EntryBase):
    NAME = "paper_exp_dae_1"
    ...
    def register(self) -> None:
        sim = Simulation(
            ...
            executable="simulation_paper_exp_dae_1",
            parameters={
                "pe_execute.computeTime_ns": int,
                "pe_access.delay_ns": int,
                "graph.depth": int,
                "graph.breadth": int,
                "factoryIndex": int
            },
                    ...
                    exps.append(
                        Experiment(
                            SIMULATION_NAME, {
                                ...
                                "pe_access.delay_ns": memoryDelay_ns,
                                "graph.breadth": 2048,
                                "graph.depth": 1
                            }
                        )
    ...
    def _do_plots(self) -> None:
        ...
        axes.set_title("Decoupled Access/Execute")
        axes.loglog(base=2)
