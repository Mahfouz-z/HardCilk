...
int sc_main(int argc, char* argv[]) {
    ...
    constexpr const char* name = "paper_exp2";
    ...
    argParser.arg<unsigned int>("serialTasks", 2);
    ...
    auto& factory = paper_exp2::factories[context.get<unsigned int>("factoryIndex")];
    ...
    auto& T1 = context.set<double>("T1", 0.0);
